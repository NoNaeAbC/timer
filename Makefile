...
test_compile: example.cpp timer.h # This is just to make sure the code compiles
	g++ -Wall -Wextra -Werror example.cpp -std=c++20 -DDISABLE_TIMER_THREADS
	g++ -Wall -Wextra -Werror example.cpp -std=c++20 -DTIMER_DEBUG
	g++ -Wall -Wextra -Werror example.cpp -std=c++20 -DDISABLE_TIMER_THREADS -DTIMER_DEBUG
	g++ -Wall -Wextra -Werror example.cpp -std=c++20
